...
#define EX86_BYTE_ARG		0x080
#define EX86_HALF_ARG		0x100
	...
	int src, sljit_w srcw)
{
	...
	dst_r = (dst >= SLJIT_TEMPORARY_REG1 && dst <= SLJIT_GENERAL_REG1) ? dst : TMP_REGISTER;

	if (src & SLJIT_IMM) {
		TEST_FAIL(emit_mov(compiler, dst_r, 0, SLJIT_IMM, srcw));
	}
	else {
